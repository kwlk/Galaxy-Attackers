...
class Map:
    ...
    def turn(self, player: Player):
        ...
        for o in self.obstacles:
            distance = o.position.distance(player.position)
            if not self.player_rect.collidepoint(o.get_position().getx(), o.get_position().gety()):
                obstacles_to_remove.append(o)
            ##if o.get_state == 1:
            ##    self.obstacles.remove(o)
            elif distance < player.hit_box_size or distance < o.hit_box_size:
                player.take_damage(o.get_dmg())
                obstacles_to_remove.append(o)
            else:
                o.move(self.obstacles_speed)
                pygame.display.blit(o.get_image, (o.get_position.getx, o.get_position.gety))
