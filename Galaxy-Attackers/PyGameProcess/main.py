...
game_map = Map(screen=screen, x=size[0], y=size[1], obstacles_speed=1, mobs_down_speed=20,
...
player = Player(speed_vector=Position(0, 0), max_hp=7, position=player_position,
